  ...
  return (
    <div className="px-8 py-12 lg:px-16 sm:rounded shadow bg-white relative h-[360px] w-[450px] flex justify-center">
      <div>
        ...
        <h1 className="text-2xl text-center font-bold mb-6">Аккаунт створено</h1>
        <p className="text-center text-neutral-400 text-sm mb-16">
          Чекайте лист на вказану поштову скриньку та слідуйте інструкціям в ньому для завершення реєстрації.
        </p>
