  ...
  return (
    <div className="px-8 py-12 lg:px-16 sm:rounded shadow bg-white relative h-[350px] w-[450px] flex justify-center">
      <div>
        ...
        <h1 className="text-2xl text-center font-bold mb-6">Лист надіслано</h1>
        <p className="text-center text-neutral-400 text-sm mb-16">Відкрийте лист та слідуйте інструкціям в ньому.</p>
